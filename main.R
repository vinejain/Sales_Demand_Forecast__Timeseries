...
global_data <- read.csv("Global Superstore.csv", stringsAsFactors = T
                        , header = T, na.strings = c("","NA","n/a"), strip.white = T, fill = T)

summary(global_data$Market)
...
## Profitability Index (using Coeff. Of Var)
...
# Top 5 Segments balancing Total Profit and Profitability Index :
